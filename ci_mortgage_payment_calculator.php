...
Version: 1.0.0
Author: Mortgage Payment Calculator / www.calculator.io
...
function display_calcio_ci_mortgage_payment_calculator(){
    $page = 'index.html';
...
add_shortcode( 'ci_mortgage_payment_calculator', 'display_calcio_ci_mortgage_payment_calculator' );